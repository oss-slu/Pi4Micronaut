...
public class FourDigitSevenSegmentDisplayHelper extends HT16K33 {
    ...
    public FourDigitSevenSegmentDisplayHelper(I2CConfig i2cConfig, Context pi4jContext) {
        super(pi4jContext.create(i2cConfig));
    ...
    public void enableDisplay(boolean enabled) {
        try {
            Method setEnabledMethod = HT16K33.class.getDeclaredMethod("setEnabled", boolean.class);
            setEnabledMethod.setAccessible(true);
            setEnabledMethod.invoke(this, enabled);
        } catch (Exception e) {
            throw new RuntimeException("Failed to call setEnabled method", e);
        }
    }
}
