...
. Make sure you have selected Micronaut version 4.7.6 or lower with Java version 17.
...
+
Note: A BCM numbering system should be used. More info can be found using this link: https://pinout.xyz.
+
[source, yaml]
----
pi4j:
