...
** Consult the https://micronaut-projects.github.io/micronaut-docs-mn4/4.7.6/guide/#creatingClient[Micronaut Documentation] for more explanation on Controllers.
