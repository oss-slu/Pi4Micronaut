...
===== Functionality
Use: `curl http://localhost:8080/active-buzzer` to test the component. The constructor and the methods these commands call within the ActiveBuzzerHelper class can be seen in our javadoc link:https://oss-slu.github.io/Pi4Micronaut/javadoc/com/opensourcewithslu/outputdevices/ActiveBuzzerHelper.html[here]. These following commands will test the component:
