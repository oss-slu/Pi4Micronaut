...
===== Link to Javadoc
====== Touch Switch javadocs include methods for the touch switch component
https://oss-slu.github.io/Pi4Micronaut/javadoc/com/opensourcewithslu/inputdevices/TouchSwitchHelper.html[Touch Switch]
