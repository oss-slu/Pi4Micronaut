...
set CLASSPATH=%APP_HOME%\lib\Home_Automation-0.1-all.jar

@rem Execute Home_Automation
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HOME_AUTOMATION_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%HOME_AUTOMATION_EXIT_CONSOLE%" exit 1
exit /b 1
