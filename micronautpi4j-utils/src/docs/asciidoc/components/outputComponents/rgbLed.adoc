...
===== A Circuit Guide
Follow this guide from https://docs.sunfounder.com/projects/raphael-kit/en/latest/c/1.1.2_rgb_led_c.html#c[Sunfounder] to build the circuit with a raphael kit.
